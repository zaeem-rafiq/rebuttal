...
def main():
    ...
    def save_results(completed):
        json_file.write_text(json.dumps({
            ...
            "rubric": "grounded-v14", "completed": completed, "results": results,
        }, indent=2) + "\n", encoding="utf-8")
    save_results(False)
    action_matches = 0
    gate_matches = 0
    ...
    with open(out_file, "w", encoding="utf-8") as f:
        ...
        f.write("**Rubric:** grounded-v14 (grounding across all strategy and evidence fields; reason, must-cite, and word count apply to narrative only). Gate measures hook interrupt request only.\n\n")
