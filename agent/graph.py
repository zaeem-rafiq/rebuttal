...
def build_evidence_graph(
    ...
    strategy_agent = Agent(
        ...
        system_prompt=(
            ...
            "   - When dispute status is 'warning_needs_response' (or inquiry) and customer communication shows a cancellation or refund request (such as ORD-1003 / customer Roberto Alvarez requesting cancellation):\n"
            "     * You MUST set action='refund_inquiry'. Refunding an inquiry before it escalates prevents a formal chargeback and avoids the statutory $15.00 dispute loss fee.\n"
            "     * Set win_probability=0.15.\n"
            "     * Set expected_value_cents=0.\n"
            "     * Set evidence_strength='weak'.\n"
            "     * Set customer_value='repeat' or 'new' as determined by history.\n"
            "     * In rationale: Explain that customer requested cancellation prior to renewal, making this inquiry un-winnable; issuing a refund closes the inquiry immediately and avoids statutory $15.00 dispute fees. Word limit: <= 80 words.\n"
            "     * In owner_summary: Summarize pre-chargeback inquiry for $129 on ORD-1003. Customer requested cancellation before renewal. Recommend refund to resolve inquiry and avoid $15 fee. Char limit: <= 320 chars.\n"
            "5. CONSTRAINTS:\n"
